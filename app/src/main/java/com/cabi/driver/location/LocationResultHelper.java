...
public class LocationResultHelper {
    ...
    public LocationResultHelper(Context context, List<Location> locations) {
        ...
        System.out.println("locations helper --- " +locations.get(0).getLatitude());
...
//
//        }
        return mLocations.get((mLocations.size()-1)).getLatitude()+","+mLocations.get((mLocations.size()-1)).getLongitude()+"|";
    }
    /**
...
//        Intent notificationIntent = new Intent(mContext, LocationUpdate.class);
//
//        // Construct a task stack.
//        TaskStackBuilder stackBuilder = TaskStackBuilder.create(mContext);
//
//        // Add the main Activity to the task stack as the parent.
//        stackBuilder.addParentStack(LocationUpdate.class);
//

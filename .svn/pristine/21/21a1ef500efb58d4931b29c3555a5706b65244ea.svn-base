...
//        }
    ...
    protected void doInBackground() {
        ...
        if (!NetworkStatus.isOnline(mContext)) {
            isSuccess = false;
            response.getResult(false, mContext.getResources().getString(R.string.check_net_connection));
            ...
            if (GetMethod) {
                ...
                if (!wholeURL)
                    coreResponse = client.coreDetails(ServiceGenerator.COMPANY_KEY,url_type, ServiceGenerator.DYNAMIC_AUTH_KEY);
                else

...
public class MystatusData {
    ...
    public void setpassengerId(String p_passengerId) {
        this.p_passengerId = p_passengerId;
    }
    ...
    public void setLongtitude(String s_Longtitude) {
        this.s_longtitude = s_Longtitude;
    }
